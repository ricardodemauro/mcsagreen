...
using Green.AlbumCopa2.Data;

namespace Green.AlbumCopa2.Controllers
{
    public class JogadorController : Controller
    {
        private albumcopaEntities db = new albumcopaEntities();

        // GET: Jogador
        public async Task<ActionResult> Index()
        {
            return View(await db.Jogadors.ToListAsync());
        }
